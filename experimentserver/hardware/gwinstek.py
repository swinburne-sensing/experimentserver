...
class LCRMeasurement(VISAEnum):
    """ Enum covering different measurement modes for an LCR meter. """
    ...
    def get_reading_map(cls):
        return {
            cls.CAP_SERIES_RES_SERIES: (('capacitance_series', unit_reg.farad), ('resistance_series', unit_reg.ohm)),
            cls.CAP_SERIES_DISSIPATION: (('capacitance_series', unit_reg.farad),
                                         ('dissipation_factor', unit_reg.dimensionless)),
            cls.CAP_PARALLEL_RES_PARALLEL: (('capacitance_parallel', unit_reg.farad),
                                            ('resistance_parallel', unit_reg.ohm)),
            cls.CAP_PARALLEL_DISSIPATION: (('capacitance_parallel', unit_reg.farad),
                                           ('dissipation_factor', unit_reg.dimensionless)),
            cls.IND_PARALLEL_RES_PARALLEL: (('inductance_parallel', unit_reg.henry),
                                            ('resistance_parallel', unit_reg.ohm)),
            cls.IND_PARALLEL_QUALITY: (('inductance_parallel', unit_reg.henry),
                                       ('quality_factor', unit_reg.dimensionless)),
            cls.IND_SERIES_RES_SERIES: (('inductance_series', unit_reg.henry), ('resistance_series', unit_reg.ohm)),
            cls.IND_SERIES_QUALITY: (('inductance_series', unit_reg.henry), ('quality_factor', unit_reg.dimensionless)),
            cls.RES_SERIES_QUALITY: (('resistance_series', unit_reg.ohm), ('quality_factor', unit_reg.dimensionless)),
            cls.RES_PARALLEL_QUALITY: (('resistance_parallel', unit_reg.ohm),
                                       ('quality_factor', unit_reg.dimensionless)),
            cls.RES_REACTANCE: (('resistance', unit_reg.ohm), ('reactance', unit_reg.ohm)),
            cls.IMPEDANCE_PHASE_RAD: (('impedance_mag', unit_reg.ohm), ('impedance_phase_rad', unit_reg.rad)),
            cls.IMPEDANCE_PHASE_DEG: (('impedance_mag', unit_reg.ohm), ('impedance_phase_deg', unit_reg.deg)),
            cls.IMPEDANCE_DISSIPATION: (('impedance', unit_reg.ohm), ('dissipation_factor', unit_reg.dimensionless)),
            cls.IMPEDANCE_QUALITY: (('impedance', unit_reg.ohm), ('quality_factor', unit_reg.dimensionless)),
            cls.DCRES: (('resistance', unit_reg.ohm),)
        }
